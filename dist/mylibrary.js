...
var wasmBinaryFile = 'mylibrary.wasm';
...
var real__mylibrary_initialize = asm["mylibrary_initialize"];
asm["mylibrary_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__mylibrary_initialize.apply(null, arguments);
};

var real__mylibrary_terminate = asm["mylibrary_terminate"];
asm["mylibrary_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__mylibrary_terminate.apply(null, arguments);
};
...
var _mylibrary_initialize = Module["_mylibrary_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["mylibrary_initialize"].apply(null, arguments)
};

var _mylibrary_terminate = Module["_mylibrary_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["mylibrary_terminate"].apply(null, arguments)
};
